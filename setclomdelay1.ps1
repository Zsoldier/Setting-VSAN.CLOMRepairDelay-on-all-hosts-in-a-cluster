...
#
$hostpass = Get-Credential -Message "Enter root creds for ESXi hosts." 
$str1="ECHO Y | c:\temp\plink.exe -pw $($hostpass.getnetworkcredential().password) -l $($hostpass.username) "
